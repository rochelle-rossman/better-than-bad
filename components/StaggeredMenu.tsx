...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  return (
    <div
      className='sm-scope z-40 fixed top-0 right-0 w-1/2 h-screen overflow-hidden'
    >
      <div
        className={
      ...
      >
        ...
        <header
          className="staggered-menu-header absolute top-0 left-0 w-full flex justify-end p-[2em] bg-transparent pointer-events-none z-20"
          aria-label="Main navigation menu"
        >
          <button
            ref={toggleBtnRef}
            className={`sm-toggle relative flex items-center gap-4 bg-transparent border-0 cursor-pointer text-lg leading-none overflow-visible pointer-events-auto ${
          ...
          >
            ...
            >
              <span
                ref={plusHRef}
                className="sm-icon-line absolute left-1/2 top-1/2 w-full h-1 bg-current rounded-sm -translate-x-1/2 -translate-y-1/2 will-change-transform"
              />
              <span
                ref={plusVRef}
                className="sm-icon-line sm-icon-line-v absolute left-1/2 top-1/2 w-full h-1 bg-current rounded-sm -translate-x-1/2 -translate-y-1/2 will-change-transform"
              />
            </span>
          </button>
        </header>
        ...
        <aside
          ...
          ref={panelRef}
          className="staggered-menu-panel absolute top-0 right-0 h-full bg-white flex flex-col border-l p-[6em_2em_2em_2em] overflow-y-auto z-10 backdrop-blur-md pointer-events-auto"
          aria-hidden={!open}
        >
                  ...
                  {socialItems.map((s, i) => (
                    <li key={s.label + i} className="sm-socials-item">
                      <a
                        ...
                        className="sm-socials-link text-[1.2rem] font-medium text-[#111] no-underline relative inline-block py-1 transition-[color,opacity] duration-300 ease-linear"
                      >
                        {s.label}
                      </a>
                    </li>
